...
describe('F289 ChatGPT Desktop development-loop tools', () => {
  ...
  it('has exactly five lifecycle tools with no merge, deploy, shell, Git, or credential input', () => {
    ...
    assert.doesNotMatch(serialized, /ownerUserId|token|credential|command|merge|deploy/i);
    assert.equal(
